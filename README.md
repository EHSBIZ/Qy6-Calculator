...
- **Optimized Performance:** Built using C++ for high efficiency and low resource usage.

## 🛠️ Technologies Used
- **C++:** Core logic and functionality.
- **Qt6 Framework:** GUI development and window management.
- **CMake:** For project build and configuration.
